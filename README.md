...
Minimal dashboard for your OpenCode usage: the rolling 5-hour, weekly and monthly plan windows, and where the spend goes — one segmented bar per window, split by model, with the detail on hover, plus your latest sessions and what each one cost.
